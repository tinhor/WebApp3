<%@ Page Title="New Worker" Language="C#" MasterPageFile="~/Administracija.Master" AutoEventWireup="true" CodeBehind="TeamLeader_Add.aspx.cs" Inherits="Administracija._TeamLeader_Add" %>
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body mt-2">
                    ...
                    <asp:Button runat="server" ID="btnNewTeamLeader" meta:resourcekey="btnNewTeamLeader" CssClass="btn btn-primary float-right" OnClick="btnNewTeamLeader_Click" />
