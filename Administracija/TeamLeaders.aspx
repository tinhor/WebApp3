<%@ Page Title="Team leaders" Language="C#" MasterPageFile="~/Administracija.Master" AutoEventWireup="true" CodeBehind="TeamLeaders.aspx.cs" Inherits="Administracija._TeamLeaders" %>
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-header">
                    <h4 class="card-title">
                        <%= Resources.Table.Table_Title_TeamLeader %>
                        <a href="TeamLeader_Add.aspx" class="btn btn-sm btn-secondary float-right m-0 waves-effect waves-light text-white"><%= Resources.Button.BtnAdd %></a>
                    </h4>
                </div>
                <!-- // -->
                    ...
                    <div class="table-responsive table-striped">
                        <table class="table">
                            ...
                            <tbody>
                                  ...
                                  <% 
                                      if (TeamLedaerList.Count > 0)
                                      {
                                          foreach (var user in TeamLedaerList)
                                          {
